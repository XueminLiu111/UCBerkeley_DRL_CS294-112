...
class Agent(object):
    ...
    def sample_action(self, policy_parameters):
        ...
        if self.discrete:
            ...
            # tf.multinomial() is same with tf.random.categorical(), just select one action=1 in the pool and all the others=0
        else:
...
def train_PG(
    ...
    start = time.time()
    #print("======path input type is:", type(video_path))
    ...
    #print("=====xliu24=====input Observation dim is:", ob_dim) #xliu24
    ac_dim = env.action_space.n if discrete else env.action_space.shape[0]
    #print("=====xliu24=====input action dim is:", ac_dim) #xliu24
    #pdb.set_trace()
    ...
    if reward_to_go:
        if normalize_advantages:
            if nn_baseline:
                video_path_init = 'results/' + env_name + '_rtg_na_baseline' +'_e' + str(num_e) +'_b' + str(min_timesteps_per_batch)\
                            + '_lr' + str(learning_rate) +'_itr0' + '.mp4'
            else:
                video_path_init = 'results/' + env_name + '_rtg_na' +'_e' + str(num_e) +'_b' + str(min_timesteps_per_batch)\
                            + '_lr' + str(learning_rate) +'_itr0' + '.mp4'
        else:
            if nn_baseline:
                video_path_init = 'results/' + env_name + '_rtg_dna_baseline'+'_e' + str(num_e) +'_b' + str(min_timesteps_per_batch)\
                            + '_lr' + str(learning_rate) +'_itr0' + '.mp4'
            else:
                video_path_init = 'results/' + env_name + '_rtg_dna'+'_e' + str(num_e) +'_b' + str(min_timesteps_per_batch)\
                            + '_lr' + str(learning_rate) +'_itr0' + '.mp4'
    else:
        if normalize_advantages:
            if nn_baseline:
                video_path_init = 'results/' + env_name + '_na_baseline'+'_e' + str(num_e) +'_b' + str(min_timesteps_per_batch)\
                            + '_lr' + str(learning_rate) +'_itr0' + '.mp4'
            else:
                video_path_init = 'results/' + env_name + '_na'+'_e' + str(num_e) +'_b' + str(min_timesteps_per_batch)\
                            + '_lr' + str(learning_rate) +'_itr0' + '.mp4'
        else:
            if nn_baseline:
                video_path_init = 'results/' + env_name + '_dna_baseline'+'_e' + str(num_e) +'_b' + str(min_timesteps_per_batch)\
                            + '_lr' + str(learning_rate) +'_itr0' + '.mp4'
            else:
                video_path_init = 'results/' + env_name + '_dna'+'_e' + str(num_e) +'_b' + str(min_timesteps_per_batch)\
                            + '_lr' + str(learning_rate) +'_itr0' + '.mp4'
    ...
    for itr in range(n_iter):
        ...
        if (itr+1)%20==0:
            ...
            if reward_to_go:
                if normalize_advantages:
                    video_path = 'results/' + env_name + '_rtg_na' + '_e' + str(num_e)\
                                +'_b' + str(min_timesteps_per_batch) + '_lr'\
                                + str(learning_rate) +'_itr' + str(itr) + '.mp4'
                else:
                    video_path = 'results/' + env_name + '_rtg_dna' + '_e' + str(num_e)\
                                +'_b' + str(min_timesteps_per_batch) + '_lr'\
                                + str(learning_rate) +'_itr' + str(itr) + '.mp4'
            else:
                if normalize_advantages:
                    video_path = 'results/' + env_name + '_na' + '_e' + str(num_e)\
                                +'_b' + str(min_timesteps_per_batch) + '_lr'\
                                + str(learning_rate) +'_itr' + str(itr) + '.mp4'
                else:
                    video_path = 'results/' + env_name + '_dna' + '_e' + str(num_e)\
                                +'_b' + str(min_timesteps_per_batch) + '_lr'\
                                + str(learning_rate) +'_itr' + str(itr) + '.mp4'
    ...
    if reward_to_go:
        if normalize_advantages:
            rews_path = 'results/' + env_name + '_rtg_na' + '_e' + str(num_e) +'_b'\
                         + str(min_timesteps_per_batch) + '_lr' + str(learning_rate) + '_test_rewards.npy'
        else:
            rews_path = 'results/' + env_name + '_rtg_dna' + '_e' + str(num_e) +'_b'\
                         + str(min_timesteps_per_batch) + '_lr' + str(learning_rate) + '_test_rewards.npy'
    else:
        if normalize_advantages:
            rews_path = 'results/' + env_name + '_na' + '_e' + str(num_e) +'_b'\
                         + str(min_timesteps_per_batch) + '_lr' + str(learning_rate) + '_test_rewards.npy'
        else:
            rews_path = 'results/' + env_name + '_dna' + '_e' + str(num_e) +'_b'\
                         + str(min_timesteps_per_batch) + '_lr' + str(learning_rate) + '_test_rewards.npy'
...
def main():
    ...
    #parser.add_argument("--video_path", '-vd', type=str, default=None, help="Path to mp4 file where the video will be recorded.")
    ...
    processes = []
    #list_episode_rews = [] #initate a list for test episode rewards
    ...
    for e in range(args.n_experiments):
        ...
        def train_func():
            ...
            #return e_episode_rews
        # # Awkward hacky process runs, because Tensorflow does not like
        # # repeatedly calling train_PG in the same thread.
        #list_episode_rews.append(e_episode_rews)
    ...
    for p in processes:
        p.join()
    #print("test episode reward for each experiment is:\n",list_episode_rews)
