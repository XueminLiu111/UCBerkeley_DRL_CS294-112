...
python main.py q3 --exp_name action4096 --num_random_action_selection 4096    #this is the default one
...
python main.py q3 --exp_name horizon15 --mpc_horizon 15  #this is the default one
...
# left to run
python main.py q3 --exp_name layers1 --nn_layers 1   #this is the default one
python main.py q3 --exp_name layers2 --nn_layers 2
python main.py q3 --exp_name layers3 --nn_layers 3  #it's running
