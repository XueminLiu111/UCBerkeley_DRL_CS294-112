...
class HalfCheetahEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    def cost_fn(states, actions, next_states):
        ...
        # penality of fell down and not move faster 
        ...
        if is_tf:
            ...
            # scores is 1*10 if front_leg >= my_range is true or 0*10 it is false
        else:
        ...
        # states[:, 17] is the angular velocity of front foot
        # increse it in the next state is good, which means it can move faster!
