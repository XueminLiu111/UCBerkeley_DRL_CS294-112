...
def plot_data(data, value="ValAverageReturn"):   #(data, value="AverageReturn"):  
...
def main():
    ...
    parser.add_argument('--value', default='ValAverageReturn', nargs='*')    #('--value', default='AverageReturn', nargs='*')
