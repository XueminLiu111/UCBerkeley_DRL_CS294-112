...
class RBF(Density_Model):   #2.2.1 in hw5a instruction
    """
...
class Exemplar(Density_Model):   #2.2.2 in hw5a instruction
    ...
    def forward_pass(self, state1, state2):  # contruct a few NN for encoder1&2 and discriminator
